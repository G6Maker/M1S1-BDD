create or replace type PERSONNE_TYPE2 as object(
    id int,
    nom varchar2(100),
    prenom varchar2(100)
)
...
create type CARACTERISTIQUES_TYPE as table of CARACTERISTIQUE_TYPE;

create type PATIENT_TYPE under PERSONNE_TYPE2(
    caracteristiques CARACTERISTIQUES_TYPE
)
FINAL;
/
...
NESTED TABLE caracteristiques STORE AS "ensCaracteristiques";
/

create table medecin of PERSONNE_TYPE2 (primary key(id));
